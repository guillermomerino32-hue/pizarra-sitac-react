...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pizarra SITAC – Protección Civil Rivas" },
      { name: "description", content: "Pizarra de Situación Táctica colaborativa para Protección Civil de Rivas-Vaciamadrid." },
